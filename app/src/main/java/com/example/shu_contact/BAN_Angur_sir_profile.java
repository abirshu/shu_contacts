...
public class BAN_Angur_sir_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ban_angur_sir_profile);
        //titile
        this.setTitle("Md. Angur Hossain ");
        //adding back Button
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel:+88 01550 059968"));
        ...
        cseChairmanMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:angur.hossain@shu.edu.bd")));
