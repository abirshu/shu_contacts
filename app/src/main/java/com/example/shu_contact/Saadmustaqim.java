...
public class Saadmustaqim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saadmustaqim);
        //titile
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel:+88 01550059966"));
        ...
        cseChairmanMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:com.so-planning@shu.edu.bd")));
