...
public class ECO_Tuhin_sir_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eco_tuhin_sir_profile);
        this.setTitle("Md Tuhin Ahmed ");
        //adding back Button
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel:+88 01764775266"));
