...
public class Shuvrochandan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shuvrochandan);
        //titile
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel:+88 015500577"));
        ...
        cseChairmanMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:ad-planning@shu.edu.bd")));
