...
public class ECO_Shovon_sir_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eco_shovon_sir_profile);
        this.setTitle("Shovon Roy ");
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel:+88 01521 220457"));
        ...
        cseChairmanMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:shovon.roy@shu.edu.bd")));
