...
public class ENG_Anushka_maam_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eng_anushka_maam_profile);
        this.setTitle("Farhana Annushka ");
        //adding back Button
        ...
        cseCharimancall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(parse("tel: +88 01000000000"));
        ...
        cseChairmanMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto: snull@shu.edu.bd")));
